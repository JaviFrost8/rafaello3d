...
export const CallToAction = () => {
  return (
    <div className="w-full flex flex-col items-center bg-background-secondary">
      ...
      <h2 className="font-display text-center text-2xl lg:text-6xl font-bold px-4">
        ¿LISTO PARA FORJAR TU VISIÓN?
      </h2>
      ...
      <Link href={'/contacto'}>
        <button className="font-display cursor-pointer bg-primary hover:bg-[#ead5fc] md:hover:px-10 mt-8 px-6 py-4 md:mt-10 md:px-8 md:py-4 rounded-[6] text-[#572285] font-semibold shadow-[0_0_30px_rgba(205,149,253,0.8)] transition-all duration-300">
          PEDIR PRESUPUESTO
        </button>
      </Link>
