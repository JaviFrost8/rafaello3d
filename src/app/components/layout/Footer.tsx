...
export const Footer = () => {
  ...
  return (
    <footer className="flex w-full bg-background-secondary min-h-[300] py-30 md:justify-center md:gap-60">
      ...
      <div className="flex flex-col justify-center items-center text-center">
        <h3 className="font-sans font-bold text-xl mb-3 text-primary">
          Navegación
        </h3>
        <nav className="hidden md:flex md:flex-col font-sans">
          <ul className="flex flex-col gap-2">
            <li>
              <Link
                href={'/'}
                className="hover:text-primary transition-all duration-400"
              >
                Inicio
              </Link>
            </li>
      ...
      <div className="flex flex-col justify-center items-center text-center">
        <h3 className="font-sans font-bold text-xl mb-3 text-primary">Legal</h3>
        <ul>
          <li className="my-2 hover:text-primary transition-all duration-400">
