  ...
  return (
    <div className="relative flex w-full h-screen">
      <div className="flex w-full items-center lg:ml-32">
        <div className="mt-6">
          <div className="font-display w-fit text-secondary font-bold bg-[#394e50] text-sm rounded-full px-3 py-1 border-2 mb-8 animate-fade-in">
          ...
          <div className="flex lg:gap-10 animate-fade-in animate-delay-400">
            <button className="mt-8 bg-primary font-sans text-black px-6 py-3 rounded-2xl font-semibold cursor-pointer shadow-[0_0_20px_rgba(205,149,253,0.6)]">
              Explorar colección
            </button>
            <button className="mt-8 bg-transparent font-sans text-primary px-6 py-3 rounded-2xl border-2 border-[#cd95fd] font-semibold cursor-pointer">
              Nuestro Proceso
            </button>
          </div>
        </div>
